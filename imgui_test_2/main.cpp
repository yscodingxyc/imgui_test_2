...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Begin("##window",nullptr, ImGuiWindowFlags_NoTitleBar);      // Create a window without a title bar 

            ImGui::Text("Hello.");                                              // Display some text (you can use a format strings too)
            ImGui::SameLine();                                                  // Using sameline ´for the title
            ImGui::TextColored(ImVec4(0.749f, 0.259f, 0.259f, 1.0f), "world!"); // TextColored and ImVec4 so we can use rgb || TODO  add colorpicker for the last word (world)
           ...
           //Function to display MousePos: x, y 
            if (ImGui::Button("MousePos"))
                mousePos = !mousePos; // change status
            ...
            //Function for Screenzize display using windows api / GetSystemMetrics
            int screenWidth = GetSystemMetrics(SM_CXSCREEN);
            int screenHeight = GetSystemMetrics(SM_CYSCREEN);
            if (ImGui::Button("Screensize"))
                Screensize = !Screensize; // change status
            if (Screensize) {
                ImGui::SameLine();
                ImGui::Text("Screensize: %d %d", screenWidth, screenHeight);
           }
